...
def main_faq_keyboard():
    keyboard = [
        ...
        [InlineKeyboardButton("📊 نتیجه آزمون کتبی", callback_data="exam_result")],
        ...
        [InlineKeyboardButton("📮 مدرک باید چی ارسال کنم و کجا؟", callback_data="send_documents")],
...
async def handle_button_click(update: Update, context: ContextTypes.DEFAULT_TYPE):
    try:
        ...
        if callback_data == "exam_time":
            ...
            آزمون عملی در هر ماه توسط سازمان فنی و حرفه ای تعیین می‌گردد و اطلاع‌رسانی از طریق مسئول فنی و حرفه ای انجام می‌گیرد.
            ...
            مدارک خود را به آیدی ادمین فنی و حرفه ای ایده پاژ ارسال کنید:
...
در غیر این صورت عکس شما توسط سازمان فنی و حرفه ای رد خواهد شد و اجازه شرکت در آزمون نخواهید داشت
            ...
            برای استعلام دهک یارانه‌ای خود می‌توانید به لینک زیر مراجعه کنید.
            """
            await query.edit_message_text(response, reply_markup=InlineKeyboardMarkup(keyboard))
            ...
            آقای سهیلی: [۹۸۹۳۵۹۲۰۲۹۹۰](tel:+989359202990)
            آقای عمرانی: [۹۸۹۳۵۵۲۵۱۰۳۹](tel:+989355251039)
            آقای سلطانی: [۹۸۹۳۷۱۵۰۰۷۱۴](tel:+989371500714)
            آقای چهارمحالی: [۹۸۹۱۵۲۰۹۳۲۴۴](tel:+989152093244)
            آقای ریاضی: [۹۸۹۳۳۰۷۶۱۷۴۱](tel:+989330761741)
            آقای صالح آبادی: [۹۸۹۳۸۹۷۹۱۱۲۲](tel:+989389791122)
            آقای اژدری: [۹۸۹۱۵۵۴۶۵۱۱۳](tel:+989155465113)
            خانم سیار: [۹۸۹۰۱۰۷۰۲۹۴۰](tel:+989010702940)
            آقای شبرنگی: [۹۸۹۰۵۱۰۹۲۹۴۰](tel:+989051092940)
            """
            ...
            دینکو: [۹۸۹۳۰۱۰۲۴۵۹۳](tel:+989301024593)
            ...
            keyboard = [
                [InlineKeyboardButton("🌐 دریافت مدرک", url="https://idepazh.ir/blog/certificate-inquiry")],
                [InlineKeyboardButton("🔙 بازگشت", callback_data="main_menu")]
            ]
            response = """
            📜 مدرک مو چجوری دریافت کنم؟
            ...
            response = """
            🎫 کارت ورود به جلسه چجوری دریافت کنم؟
            ...
            • در صورتی که باز هم با دریافت کارت مشکل مواجه شدید در روز آزمون ساعت ۷ به آدرس مشهد- میدان نمایشگاه بزرگراه آیت الله هاشمی رفسنجانی میدان خلیج فارس مجیدیه ۳۷- نبش صادقیه ۱۰ مراجعه کنید.
