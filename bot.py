...
async def handle_button_click(update: Update, context: ContextTypes.DEFAULT_TYPE):
    try:
        ...
        if callback_data == "exam_time":
            ...
            آزمون عملی در هر ماه توسط سازمان فنی و حرفه ای تعیین می‌گردد و اطلاع‌رسانی از طریق مسئول فنی و حرفه ای انجام می‌گیرد تاریخ آزمون عملی ا اگز آزمون کتبی شما از تاریخ 
            1404/05/16 تا 1404/06/15 بوده است آزمون عملی شما در تاریخ 1404/06/26  میباشد
            توجه داشته باشید.
